import { Calendar, Copy, Eye, PencilLine, ShareIcon, Trash2 } from "lucide-react";
                ...
                >
                  ...
                  <div className="flex flex-col gap-y-4 sm:items-end">
                    <div className="flex gap-2 flex-wrap sm:flex-nowrap">
                      <button
                        className="p-2 rounded-[0.2rem] bg-white border border-[#c7c7c7]  hover:bg-transparent group hover:border-[#1d3212]"
                        // onClick={() => toast.error("Not working")}
                        onClick={()=>handleshare(paste?._id)}
                      >
                       
                          <ShareIcon
                            className="text-black group-hover:text-[#e35d6f]"
                            size={20}
                          />
